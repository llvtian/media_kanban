...
const live2d_path = "https://cdn.jsdelivr.net/gh/llvtian/media_kanban@main/jsdelivr/";
...
// if (screen.width >= 768) {
	Promise.all([
		...
		initWidget({
			waifuPath: "https://cdn.jsdelivr.net/gh/llvtian/media_kanban@main/jsdelivr/json/waifu-tips.json",
			apiPath: "https://cdn.jsdelivr.net/gh/llvtian/media_kanban@main/jsdelivr/",
			cdnPath: "https://cdn.jsdelivr.net/gh/llvtian/media_kanban@main/jsdelivr/"
		});
	});
// }
