...
(function() {
    ...
    if (browser.versions.mobile || browser.versions.android || browser.versions.ios){
        ...
        m_bt.src = "https://cdn.jsdelivr.net/gh/llvtian/media_kanban@main/tongji/right_www_zsc.js";
        var s_bt = document.getElementsByTagName("script")[0];
        s_bt.parentNode.insertBefore(m_bt, s_bt);
    }else{
        var m_bt = document.createElement("script");
        m_bt.src = "https://cdn.jsdelivr.net/gh/llvtian/media_kanban@main/cdnjsdelivrMedia/js/right.js";
        var s_bt = document.getElementsByTagName("script")[0];
        s_bt.parentNode.insertBefore(m_bt, s_bt);
    }
})();